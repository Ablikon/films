...
const movieCouples = [
  {
    ...
    letter: 'Моя бриллиантик, как герои этого фильма, мы доказали, что настоящая любовь рождается в огне страсти и споров. Ты не покорилась мне - ты покорила меня! Твой характер, твоя сила, твоя независимость делают тебя неповторимой. С тобой каждый день —-это танец двух равных душ, где мы учимся любить, уступать и побеждать вместе. Ты моя королева и моя вторая половинка. 👑💕'
  },
  {
    id: 2,
    ...
    letter: 'Солнышко, наша любовь, как у Глории и Джея, доказывает, что настоящие чувства не знают границ. Ты вошла в мою жизнь как вихрь эмоций, страсти и невероятной красоты. С тобой каждый день — это праздник, полный тепла, смеха и бесконечной любви. Ты моя музыка, мой танец, мое счастье. Gracias por todo, mi amor! 🌹'
  },
  {
    id: 3,
  ...
  },
  {
    ...
    letter: 'Мы как Амели и Нино, наша история полна маленьких чудес и невероятных совпадений. Ты научила меня видеть красоту в мелочах и находить магию в обычных днях. С тобой жизнь превращается в сказку, где каждый момент наполнен теплом, улыбками и нежностью. Ты - мое самое большое приключение, мое маленькое чудо, моя судьба. Je t\'aime! ✨'
  },
  {
    id: 6,
    originalImage: '/6-orig.jpg',
    generatedImage: '/6-gen.png',
    movieTitle: 'Ла-Ла Ленд',
    characters: 'Себастьян и Миа',
    letter: 'Моя звезда, как герои Ла-Ла Ленда, мы танцуем под музыку наших сердец. Ты вдохновляешь меня мечтать, творить и верить в невозможное. С тобой каждый день - это импровизация, полная страсти, романтики и ярких красок. Даже когда жизнь сложна, мы создаем свою волшебную мелодию. Ты - моя главная мечта, мой звездный дуэт, моя любовь на века. ⭐'
  },
  {
    id: 7,
    originalImage: '/7-orig.png',
    generatedImage: '/7-gen.png',
    movieTitle: 'Полночь в Париже',
    characters: 'Гил и Адриана',
    letter: 'Моя муза, как в Полночи в Париже, ты — мое вдохновение, мой золотой век. С тобой каждая прогулка превращается в романтическое приключение, каждый разговор - в стихи. Ты делаешь реальность лучше любых фантазий. Ты — мое идеальное время, мое идеальное место, моя идеальная любовь. 💫'
  },
  {
    id: 8,
    originalImage: '/8-orig.jpg',
    generatedImage: '/8-gen.png',
    movieTitle: 'Век Адалин',
    characters: 'Адалин и Эллис',
    letter: 'Моя вечная любовь, как Адалин и Эллис, наша история доказывает, что настоящая любовь вне времени. Ты заставила меня поверить, что можно открыть сердце, довериться, жить по-настоящему. С тобой я готов проживать каждый день как единственный и неповторимый. Ты остановила время — время без тебя. Теперь каждое мгновение с тобой бесценно. Моя любовь к тебе вечна. 💕'
  }
];
